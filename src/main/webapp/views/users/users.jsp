    ...
    <div class="content">
        ...
        <div class="users-table">
            ...
            <table>
                ...
                <tbody>
                <% for (UserDTO userr : users) {
                    String initial = userr.getNom() != null && !userr.getNom().isEmpty() ?
                            userr.getNom().substring(0, 1).toUpperCase() : "U";
                %>
                <tr>
                    <td>
                        <div class="user-info">
                    ...
                    <td>
                                    <span class="role-badge role-<%= userr.getRole().name().toLowerCase() %>">
                                        <%= userr.getRole().name() %>
                                    </span>
                    </td>
                    <td>
                        <% if (userr.getTypeSpecifique() != null) { %>
                        <span class="type-badge"><%= userr.getTypeSpecifique() %></span>
                        <% } %>
                    </td>
                    <td>
                        <% if (userr.getInfoSupplementaire() != null && !userr.getInfoSupplementaire().isEmpty()) { %>
                        <span class="info-badge"><%= userr.getInfoSupplementaire() %></span>
                        <% } %>
                    </td>
                    <td>
                                    <span class="status-badge <%= userr.isStatus() ? "status-active" : "status-inactive" %>">
                                        <%= userr.isStatus() ? "ACTIF" : "INACTIF" %>
                                    </span>
                    </td>
                    ...
                    <td>
                        <div class="actions-cell">
                            <!-- Bouton Édition -->
                            <a href="users?action=edit&id=<%= userr.getId() %>"
                               class="btn-toggle"
                               style="background: var(--info); color: white;">
                                <i class="fas fa-edit"></i>
                            </a>

                            <a href="users?action=toggleStatus&id=<%= userr.getId() %>"
                               class="btn-toggle"
                               onclick="return confirm('Êtes-vous sûr de vouloir <%= userr.isStatus() ? "désactiver" : "activer" %> cet utilisateur ?')">
                                <i class="fas <%= userr.isStatus() ? "fa-pause" : "fa-play" %>"></i>
                            </a>
                            <a href="users?action=delete&id=<%= userr.getId() %>"
                               class="btn-delete"
